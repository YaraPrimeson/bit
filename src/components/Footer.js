            ...
            <div className={style.footer}>
                <div className={style.list}>
                    <div className={style.list__container}>
                        ...
                        <a href="https://www.bitflex.com/partners" target="_self" className={style.link}>All
                            Partners</a>
                    ...
                    <div className={style.list__container}>
                        ...
                        <img className={style.img} src={QRCode} alt="qr code"/>
                    </div>
                </div>
            ...
            <footer className={style.footer2}>
                <Accordion className={style.accordion}>
                    ...
                    <AccordionDetails className={style.text__container}>
                        <p className={style.accordion__text}>About Us</p>
                        <p className={style.accordion__text}>All Partners</p>
                        <p className={style.accordion__text}>Careers</p>
                        <p className={style.accordion__text}>Terms of Use</p>
                        <p className={style.accordion__text}>Privacy Policy</p>
                        <p className={style.accordion__text}>Legal Statement</p>
                    </AccordionDetails>
                </Accordion>
                <Accordion className={style.accordion}>
                    <AccordionSummary
                    ...
                    <AccordionDetails className={style.text__container}>
                        ...
                        <p className={style.accordion__text}>Derivatives</p>
                    </AccordionDetails>
                </Accordion>
                <Accordion className={style.accordion}>
                    <AccordionSummary
                    ...
                    <AccordionDetails className={style.text__container}>
                        <p className={style.accordion__text}>Help Center</p>
                        <p className={style.accordion__text}>Media Kit</p>
                        <p className={style.accordion__text}>Blog</p>
                        <p className={style.accordion__text}>Affiliates</p>
                        <p className={style.accordion__text}>Fee structure</p>
                        <p className={style.accordion__text}>API Documentation</p>
                    </AccordionDetails>
                </Accordion>
                <Accordion className={style.accordion}>
                    <AccordionSummary
                    ...
                    <AccordionDetails className={style.text__container}>
                        <p className={style.accordion__text}>BTC/USDT</p>
                        <p className={style.accordion__text}>ETH/USDT</p>
                        <p className={style.accordion__text}>XRP/USDT</p>
                        <p className={style.accordion__text}>BTC/USDT-P</p>
                        <p className={style.accordion__text}>ETH/USDT-P</p>
                        <p className={style.accordion__text}>XRP/USDT-P</p>
                    </AccordionDetails>
                </Accordion>
                <div className={style.BITFLEX__svg}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="none" viewBox="0 0 40 40">
                        <rect width="40" height="40" fill="#99F8A7" rx="12"></rect>
                        <path fill="#000"
                              d="M25.814 15.037h3.802a.367.367 0 00.264-.119.41.41 0 00.115-.28V12.4a.39.39 0 00-.115-.281.376.376 0 00-.264-.119h-4.033c-1.128 0-2.112.495-2.919 1.476L20 16.936l-2.66-3.47c-.811-.97-1.8-1.466-2.928-1.466h-4.033a.367.367 0 00-.264.119.411.411 0 00-.115.28v2.238a.41.41 0 00.115.281.367.367 0 00.264.12h3.817c.264 0 .494.118.691.356l3.145 4.104-3.135 4.094c-.202.238-.437.352-.716.352H10.38a.367.367 0 00-.264.119.429.429 0 00-.115.295v2.223c0 .114.043.22.11.295a.374.374 0 00.27.124h4.032c1.128 0 2.112-.495 2.933-1.476L20 22.064l2.66 3.47c.811.97 1.8 1.466 2.928 1.466h4.033c.1 0 .197-.043.264-.119a.429.429 0 00.115-.295v-2.223a.416.416 0 00-.115-.295.367.367 0 00-.264-.12h-3.802c-.279 0-.51-.114-.706-.342l-3.145-4.104 3.14-4.094c.202-.242.437-.361.71-.361l-.004-.01z"></path>
                    </svg>
                    <p className={style.BITFLEX}> © 2024 BITFLEX.</p>
                </div>
                ...
                <div className={style.btn__container}>
                    <button className={style.btn}>Download BITFLEX App</button>
                </div>
            </footer>
        </>
    );
